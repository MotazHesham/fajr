...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.said-aboutuses.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label class="required" for="job_title">{{ trans('cruds.saidAboutUs.fields.job_title') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.saidAboutUs.fields.job_title_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.saidAboutUs.fields.photo_helper') }}90x90</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    url: '{{ route('admin.said-aboutuses.storeMedia') }}',
    maxFilesize: 4, // MB
