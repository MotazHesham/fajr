    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" type="number" name="experience" id="experience" value="{{ old('experience', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clients') ? 'is-invalid' : '' }}" type="number" name="clients" id="clients" value="{{ old('clients', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('solutions') ? 'is-invalid' : '' }}" type="number" name="solutions" id="solutions" value="{{ old('solutions', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('building_text') ? 'is-invalid' : '' }}" name="building_text" id="building_text" required>{{ old('building_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('trmem') ? 'is-invalid' : '' }}" name="trmem" id="trmem" required>{{ old('trmem') }}</textarea>
                @if($errors->has('trmem'))
                    <div class="invalid-feedback">
                        {{ $errors->first('trmem') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('fix_text') ? 'is-invalid' : '' }}" name="fix_text" id="fix_text" required>{{ old('fix_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('decore_text') ? 'is-invalid' : '' }}" name="decore_text" id="decore_text" required>{{ old('decore_text') }}</textarea>
